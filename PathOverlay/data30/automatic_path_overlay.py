...
bag_path = Path(r'C:\Users\Danii\Documents\BagTest\PathOverlay\data30\bag_test_0')  # adjust as needed
    ...
    try:
        with AnyReader([bag_path]) as reader:
            ...
            for connection, timestamp, rawdata in reader.messages(connections):
                ...
                offset = 1
                origin_x = origin.position.x * 1.8
                origin_y = origin.position.y + 0.5
